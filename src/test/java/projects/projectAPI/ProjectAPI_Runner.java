...
class ProjectAPI_Runner {
    
    @Karate.Test
    Results testAll() {
        Results results = Karate.run("classpath:projects/projectAPI/features")
                .systemProperty("project", "projectAPI")
                .parallel(1);
...
//                         ReportNotifier.sendTeamsReport(teamsWebhook, "ProjectAPI", total, passed, failed);
//                     }
...
//                         ReportNotifier.sendEmailReport(smtpHost, username, password, from, to, "ProjectAPI", total, passed, failed);
//                     }
//                 }
//             }
//         } catch (Exception e) {
